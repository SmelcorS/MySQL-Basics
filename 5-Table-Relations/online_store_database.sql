...
CREATE TABLE `order_items` (
    ...
    CONSTRAINT `fk_order_types_items` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`),
    CONSTRAINT `fk_order_types_orders` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
);
